...
function Hero() {
  return (
    <section id="home" className="container mx-auto grid grid-cols-1 md:grid-cols-2 pt-20 md:pt-28 pb-4 px-4 sm:px-6 lg:px-8">
      {/* First Box */}
      <div className="space-y-6">
        ...
        <div className="space-y-8 pl-1">
          ...
          <h1 className="text-gray-700 text-2xl sm:text-4xl sm:leading-12 md:text-2xl md:leading-normal lg:text-5xl lg:leading-tight font-semibold">
            ...
            <span className="font-bold bg-gradient-to-r from-blue-400 to-red-500 text-transparent bg-clip-text">
      ...
      {/* Second Box */}
      <div className="hidden md:block p-12 pr-6">
        <div>
            <img src={heroImage} alt="Hero image" className="rounded-4xl -mt-16" />
        </div>
      </div>
    </section>
  );
